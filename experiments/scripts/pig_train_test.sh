...
# CCNN
CONFIG_FILE=models/pigs/ccnn_trancos_cfg.yml
CAFFE_MODEL=genfiles/output_models/pigs/ccnn/ccnn_trancos_iter_50000.caffemodel
DEPLOY=models/pigs/ccnn_deploy.prototxt
SOLVER=models/pigs/ccnn_solver.prototxt

# HYDRA 2s
#CONFIG_FILE=models/trancos/hydra2/hydra2_trancos_cfg.yml
#CAFFE_MODEL=genfiles/output_models/trancos/hydra2/hydra2_trancos_iter_30000.caffemodel
...
#CAFFE_MODEL=genfiles/output_models/trancos/hydra3/hydra3_trancos_iter_30000.caffemodel
...
#CAFFE_MODEL=genfiles/output_models/trancos/hydra4/hydra4_trancos_iter_30000.caffemodel
